...
LOCAL_SRC_FILES := proprietary/app/CACertService/CACertService.apk
...
LOCAL_MODULE := CneApp
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/app/CneApp/CneApp.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_SUFFIX := .apk
...
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/app/IWlanService/IWlanService.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_SUFFIX := .apk
...
include $(CLEAR_VARS)
LOCAL_MODULE := MotionSenseBridgePrebuilt
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/product/app/MotionSenseBridgePrebuilt/MotionSenseBridgePrebuilt.apk
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_CERTIFICATE := platform
...
include $(CLEAR_VARS)
LOCAL_MODULE := OsloFeedback
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/product/priv-app/OsloFeedback/OsloFeedback.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_PRODUCT_MODULE := true
...
include $(CLEAR_VARS)
LOCAL_MODULE := RefreshRateControl
LOCAL_MODULE_OWNER := google
LOCAL_SRC_FILES := proprietary/product/priv-app/RefreshRateControl/RefreshRateControl.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_PRODUCT_MODULE := true
